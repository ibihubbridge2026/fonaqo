...
class Country {
  ...
  /// Pays disponibles pour FONACO (Tous les pays du monde)
  static const List<Country> availableCountries = [
    ...
    Country(
        name: 'Sahara occidental', code: 'EH', dialCode: '+212', flag: '🇪🇭'),
    Country(
    ...
    Country(name: 'Taïwan', code: 'TW', dialCode: '+886', flag: '🇹🇼'),
    ...
    Country(name: 'Îles Salomon', code: 'SB', dialCode: '+677', flag: '🇸🇧'),
